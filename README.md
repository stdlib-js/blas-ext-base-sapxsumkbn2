...
```javascript
import sapxsumkbn2 from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-sapxsumkbn2@v0.2.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-sapxsumkbn2/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/blas-ext-base-sapxsumkbn2/actions/workflows/test.yml?query=branch:v0.2.1
